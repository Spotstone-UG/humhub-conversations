...
$postReaction = (string) file_get_contents($root . '/services/ContentEmojiReactionService.php') . (string) file_get_contents($root . '/controllers/ContentReactionController.php') . (string) file_get_contents($root . '/Events.php') . (string) file_get_contents($root . '/config.php') . (string) file_get_contents($root . '/widgets/ContentEmojiReactionLink.php') . (string) file_get_contents($root . '/widgets/views/contentEmojiReactionLink.php') . (string) file_get_contents($root . '/views/post-reaction/picker.php') . (string) file_get_contents($root . '/resources/conversations.js');
foreach (['ContentEmojiReaction', 'ContentActiveRecord', 'ContentAddonActiveRecord', 'EmojiPaletteService', "renderAjax('/post-reaction/picker'", 'onLikeLinkAfterRun', 'LikeLink::EVENT_AFTER_RUN', 'ContentEmojiReactionLink::supports', '->content->canView()', 'protected $access = null', "'data-conversation-reaction-submit' => 'true'", 'data-conversation-reaction-target', 'X-Requested-With', 'current.replaceWith(replacement)', "'html' => ContentEmojiReactionLink::widget", "->with('user')", "'users' => []", 'Reagiert von:', 'Weitere Reaktion', 'user/profile/stream', 'user/profile/home', 'space/space/stream', 'space/space/home'] as $requiredToken) {
