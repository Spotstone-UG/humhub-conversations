...
foreach (['ContentEmojiReaction', 'ContentActiveRecord', 'ContentAddonActiveRecord', 'EmojiPaletteService', "renderAjax('/post-reaction/picker'", 'onLikeLinkAfterRun', 'LikeLink::EVENT_AFTER_RUN', 'ContentEmojiReactionLink::supports', 'protected $access = null', "'data-conversation-reaction-submit' => 'true'", 'data-conversation-reaction-target', 'X-Requested-With', 'current.replaceWith(replacement)', "'html' => ContentEmojiReactionLink::widget", 'user/profile/stream', 'user/profile/home', 'space/space/stream', 'space/space/home'] as $requiredToken) {
