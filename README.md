...
- **V1.6:** Alle Like-fähigen Stream- und Karteninhalte in aktivierten Spaces – einschließlich Galerie, Kalender, PeerTube-Videos und der von Sociocratic Governance erzeugten Beiträge – ersetzen das native binäre **Gefällt mir** durch **Reagieren** mit derselben vollständigen Emoji-Palette und einer kompakten Reaktionsleiste, ohne HumHub-Core-Dateien zu ändern. Die Ersetzung erfolgt direkt am gemeinsamen HumHub-Like-Widget, sodass sie auch für abweichende Modulansichten gilt.
...
11. **Content reactions:** Prüfe bei einem normalen Beitrag, Galerie-Bild, Kalendereintrag, PeerTube-Video und Sociocratic-Governance-Beitrag, dass **Reagieren** das native **Gefällt mir** ersetzt. Wähle ein Emoji aus, prüfe den Zähler und entferne die eigene Reaktion erneut über denselben Chip.
