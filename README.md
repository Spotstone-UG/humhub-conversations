...
- **V1.6:** Alle normalen Beiträge in aktivierten Spaces – einschließlich der von Sociocratic Governance erzeugten Stream-Beiträge – ersetzen das native binäre **Gefällt mir** durch **Reagieren** mit derselben vollständigen Emoji-Palette und einer kompakten Reaktionsleiste, ohne HumHub-Core-Dateien zu ändern.
...
11. **Post reactions:** On a normal Space post and a Sociocratic-Governance Stream-Beitrag, confirm **Reagieren** replaces **Gefällt mir**. Open the picker, search an emoji and confirm the selected emoji is counted; select the same chip again to remove the personal reaction.
