...
5. Clear HumHub caches if the deployment process requires it, then open that Space's Conversation route.
...
1. **Basic conversation:** Member A creates a conversation with title and summary. Confirm a compact card appears in the ordinary Space stream and no comments appear below it.
