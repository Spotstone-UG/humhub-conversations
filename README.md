...
- **V1.6:** Normal Space posts keep their native **Gefällt mir** link and additionally receive **Reaktion** with the same full emoji palette, without changing any HumHub core file.
...
11. **Post reactions:** On a normal Space post, confirm **Gefällt mir** remains available and **Reaktion** appears beside it. Open the picker, search an emoji and confirm the selected emoji is counted; select the same chip again to remove the personal reaction.
